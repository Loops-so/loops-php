# Contributing to Loops PHP SDK

Thank you for your interest in contributing to Loops PHP SDK. We welcome contributions from the community and are excited to see what you'll bring to the project.

## Getting Started

1. Fork the repository on GitHub.
2. Clone your fork locally: `git clone <https://github.com/Loops-so/loops-php.git`>
